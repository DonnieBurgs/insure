...
<form id="commonForm" action="/emAuthority.do?method=update" method="post">
	<table class="tform">
<tr>
<td width="120" class="right">权限名称：</td>
<td><input type="text" id="authorityname" name="authorityname" value="${fn:replace(item.authorityname,'"','&quot;')}" size=50></td>
</tr>
<tr>
<td width="120" class="right">权限代码：</td>
<td><input type="text" id="authorityno" name="authorityno" value="${fn:replace(item.authorityno,'"','&quot;')}" size=50></td>
</tr>
<tr>
<td width="120" class="right">类别：：</td>
<td><input type="text" id="ctype" name="ctype" value="${fn:replace(item.ctype,'"','&quot;')}" size=50></td>
</tr>
<tr>
...
function checkf() {
	if(commonForm.authorityname.value=="") {alert("请正确输入权限名称！");return false;}
	if(commonForm.authorityno.value=="") {alert("请正确输入权限代码！");return false;}
	if(commonForm.ctype.value=="" || commonForm.ctype.value!="" && !is_int(commonForm.ctype.value)) {alert("请正确输入类别：！");return false;}

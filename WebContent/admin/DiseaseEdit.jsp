...
<td>
<label><input type="radio"  name="critical" value="0" <c:if test="${item.critical eq '0'}">checked=checked</c:if>>否</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio"  name="critical" value="1" <c:if test="${item.critical eq '1'}">checked=checked</c:if>>是</label>
</td>
</tr>
<tr>

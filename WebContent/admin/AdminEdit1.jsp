...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">用户编辑</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form id="userForm" action="/emAdmin1.do?method=update" method="post">
	<table class="tform">
<tr>
...
<tr>
	...
	<td><input id="adminname" name="adminname" type="text" value="${item.adminname}"/></td>
</tr>
<tr>
...
function checkf() {
  if(userForm.adminname.value=="" || userForm.adminname.value.length>10) {alert("请正确输入姓名！长度不超过10个汉字。");userForm.adminname.focus();return false;}

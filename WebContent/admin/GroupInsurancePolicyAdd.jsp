...
<td>
<dict:select path="applicantcompanyid" name="id" label="applicantcompanyname" defaultValue="true" table="em_applicantcompany" />
</td>
<td width="120" class="right">承保公司：</td>
<td>
<dict:select path="insurercompanyid" name="id" label="insurercompanyname" defaultValue="true" table="em_insurercompany" />
</td>
</tr>
<tr>
...
<td colspan="3"><input type="text" id="premium" name="premium" value="" size=50></td>
</tr>
<tr>

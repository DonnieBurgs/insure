...
<td><input type="text" id="hospitalcode" name="hospitalcode" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="province" name="province" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">地级：</td>
<td><input type="text" id="region" name="region" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">县级：</td>
<td><input type="text" id="county" name="county" value="" size=50></td>
</tr>

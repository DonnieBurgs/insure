...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">险种添加</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><input type="text" id="insurancename" name="insurancename" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">险别代码：</td>
<td><input type="text" id="insurancecode" name="insurancecode" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">险别类型：</td>
<td><input type="text" id="insurancetype" name="insurancetype" value="" size=50></td>
</tr>

...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">会员添加</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:history.back();" style="margin-left:100px;"><i class="iconfont">&#xe681;</i>返回列表</a></div>
	<div class="operationRight f-r">
	</div>
</div>
<form id="commonForm" action="/emUser.do?method=add" method="post">
	<table class="tform">
<tr>
<td width="120" class="right">账号：</td>
<td><input type="text" id="account" name="account" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="nickname" name="nickname" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">工号：</td>
<td><input type="text" id="userno" name="userno" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="usertype" name="usertype" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">推荐人ID：</td>
<td><input type="text" id="parentid" name="parentid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">性别：</td>
<td><input type="text" id="sex" name="sex" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">年龄：</td>
<td><input type="text" id="age" name="age" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">身份证：</td>
<td><input type="text" id="identity" name="identity" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="isregist" name="isregist" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">微信Openid：</td>
<td><input type="text" id="openid" name="openid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">二维码：</td>
<td><input type="text" id="qrurl" name="qrurl" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="tel" name="tel" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="devicetoken" name="devicetoken" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">token刷新时间：</td>
<td><input type="text" id="devicetokendate" name="devicetokendate" readonly="readonly" value="" onclick="WdatePicker({maxDate:'2018-12-31', dateFmt:'yyyy-MM-dd'})" style="width: 70px;"/></td>
</tr>
<tr>
...
<td><input type="text" id="latlngdate" name="latlngdate" readonly="readonly" value="" onclick="WdatePicker({maxDate:'2018-12-31', dateFmt:'yyyy-MM-dd'})" style="width: 70px;"/></td>
</tr>
<tr>
<td width="120" class="right">设备ID：</td>
<td><input type="text" id="deviceid" name="deviceid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">顺序号：</td>
<td><input type="text" id="seq" name="seq" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">权限ID：</td>
<td><input type="text" id="authorityid" name="authorityid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">是否删除：</td>
<td><input type="text" id="isdelete" name="isdelete" value="" size=50></td>
</tr>

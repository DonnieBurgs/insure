...
<c:forEach var="item" items="${resultRows}">
			<tr>
<td>
<dict:itemdesc name="applicantcompanyname" value="${item.applicantcompanyid }" table="em_applicantcompany" path="id"/>
<td>
<dict:itemdesc name="insurercompanyname" value="${item.insurercompanyid }" table="em_insurercompany" path="id"/>
</td>
...
function deleteGroupInsurancePolicy(id){
	if(confirm("是否删除会员资料？")) {
		$("#id").val(id);
		$("#t").val(t);
		deleteForm.submit();

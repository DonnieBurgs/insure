...
MarkerClusterer.prototype._pushMarkerTo = function(marker){
    ...
    this.markers.push(marker);//Marker�Ϸź�enableDragging����仯������
};
...
MarkerClusterer.prototype._createClusters = function(){
    ...
    for(var i = 0, marker; marker = this.markers[i]; i++){
        if(!marker.isInCluster && extendedBounds.containsPoint(marker.getPoint()) ){           // //ȫ��һ�������� �ȶ��㷨
...
//..........................................
//Cluster�࣬t��MarkerClusterer��ClusterMarker��һ��Cluster���ж���ʼMarker
...
Cluster.prototype.addMarker = function(marker){
    ...
    if(len < this.minClusterSize ){      //marker.isAddedToMap �������ж�һ�£�Baidu�Լ��ж�
...
Cluster.prototype.updateClusterMarker = function(){
    ...
    this.clusterMarker.setBounds(this.getBounds());//����Bounds
};
...
ClusterMarker.prototype.IMAGE_PATH = 'images/map';

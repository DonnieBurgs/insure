	...
	function ChangeNav(nav){//菜单跳转
		...
		$("#menu").find("#items_"+nav).show().find("ul li a").removeClass("thisclass");
		$("#menu").find("#items_"+nav).show().find("dl dd").eq(0).show().find("dd ul li a").eq(0).addClass("thisclass").blur();
	}

...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">保险商品添加</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:history.back();" style="margin-left:100px;"><i class="iconfont">&#xe681;</i>返回列表</a></div>
	<div class="operationRight f-r">
	</div>
</div>
<form id="commonForm" action="/emProduct.do?method=add" method="post">
	<table class="tform">
<tr>
<td width="120" class="right">产品名称：</td>
<td><input type="text" id="productname" name="productname" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">产品描述：</td>
<td><input type="text" id="info" name="info" value="" size=50></td>
</tr>
<tr>

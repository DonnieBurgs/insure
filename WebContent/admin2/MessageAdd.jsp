...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">消息添加</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:history.back();" style="margin-left:100px;"><i class="iconfont">&#xe681;</i>返回列表</a></div>
	<div class="operationRight f-r">
	</div>
</div>
<form id="commonForm" action="/emMessage.do?method=add" method="post">
	<table class="tform">
<tr>
<td width="120" class="right">消息会话ID：</td>
<td><input type="text" id="messagesessionid" name="messagesessionid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">群发ID：</td>
<td><input type="text" id="groupid" name="groupid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">消息类型ID：</td>
<td><input type="text" id="messagetypeid" name="messagetypeid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">发送人ID：</td>
<td><input type="text" id="sender" name="sender" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">接收人ID：</td>
<td><input type="text" id="receiver" name="receiver" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="groupseq" name="groupseq" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">是否新消息：</td>
<td><input type="text" id="senderread" name="senderread" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">是否新消息：</td>
<td><input type="text" id="receiverread" name="receiverread" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">是否删除：</td>
<td><input type="text" id="senderdelete" name="senderdelete" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">是否删除：</td>
<td><input type="text" id="receiverdelete" name="receiverdelete" value="" size=50></td>
</tr>
<tr>

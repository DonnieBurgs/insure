...
/*
	<servlet>
		...
		<servlet-class>com.web.servlet.admin.EmSyslogtypeServlet</servlet-class>
	</servlet>
	<servlet-mapping>
		<servlet-name>emSyslogtype</servlet-name>
...
public class EmSyslogtypeServlet extends UserSecureDispatcher {
	...
	private static final long serialVersionUID = 1491449284408L;
	...
	public void fill(HttpServletRequest request, HttpServletResponse response)
		...
		String syslogtypeid = Putil.getString(request.getParameter("syslogtypeid")) ;
		if(syslogtypeid.length()>0) {
			Map<String, Object> row = DbUtils.queryOne("select p.* from em_syslogtype p where p.syslogtypeid="+syslogtypeid);
	...
	public void update(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringBuilder select = new StringBuilder("update em_syslogtype set "
					...
					+ ",seq=" + seq + ""
				+ " where syslogtypeid=" + syslogtypeid + "" 
			);
			int result = DbUtils.save(select.toString());
	...
	public void list(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringBuilder countSql = new StringBuilder("select count(p.syslogtypeid) as total from em_syslogtype p where p.syslogtypeid>=0"
			...
			// 列表分页语句
			resultRows = DbUtils.query("select p.* from em_syslogtype p where p.syslogtypeid>=0"
					+ (keyword.length()>0?" and p.syslogtypename like '%" + keyword + "%'":"")

...
/*
	<servlet>
		...
		<servlet-class>com.web.servlet.admin.EmClaimImageServlet</servlet-class>
	</servlet>
	<servlet-mapping>
		<servlet-name>emClaimImage</servlet-name>
...
public class EmClaimImageServlet extends UserSecureDispatcher {
	...
	private static final long serialVersionUID = 1491449284086L;
	
	public void blank(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String auth50 = request.getAttribute("auth50");
    	if(auth50.equals("")) {
	...
	public void fill(HttpServletRequest request, HttpServletResponse response)
		...
		String claimimageid = Putil.getString(request.getParameter("claimimageid")) ;
		if(claimimageid.length()>0) {
			Map<String, Object> row = DbUtils.queryOne("select p.* from em_claimimage p where p.claimimageid="+claimimageid);
	...
	public void update(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringBuilder select = new StringBuilder("update em_claimimage set "
				...
				+ " where claimimageid=" + claimimageid + "" 
			);
			int result = DbUtils.save(select.toString());
	...
	public void list(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			StringBuilder countSql = new StringBuilder("select count(p.claimimageid) as total from em_claimimage p where p.claimimageid>=0"
			...
			// 列表分页语句
			resultRows = DbUtils.query("select p.* from em_claimimage p where p.claimimageid>=0"
					+ (keyword.length()>0?" and p.claimimagename like '%" + keyword + "%'":"")

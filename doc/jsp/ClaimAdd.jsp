...
<div class="operation o-h bg-f8">
	<div class="operationLeft f-l"><font style="margin-left:10px;font-size:14px; font-weight:bold; text-indent:14px; letter-spacing:2px;">案件添加</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><input type="text" id="claimarchiveid" name="claimarchiveid" value="" size=50></td>
</tr>
<tr>
<td width="120" class="right">序号：</td>
<td><input type="text" id="serialnumber" name="serialnumber" value="" size=50></td>
</tr>
<tr>
...
<td><input type="text" id="bardh" name="bardh" value="" size=50></td>
</tr>
